...
#include "Lib/MeshMergeFunctionLibrary.h"
...
static void ToMergeParams(const TArray<FSkelMeshMergeUVTransformMappings>& InUVTransformsPerMesh, TArray<FSkelMeshMergeUVTransforms>& OutUVTransformsPerMesh)
{
