...
struct DEDISERVERTEST_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct DEDISERVERTEST_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct DEDISERVERTEST_API FSkelMeshMergeUVTransformMappings
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct DEDISERVERTEST_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    TArray<FSkelMeshMergeUVTransformMappings> UVTransformsPerMesh;
 ...
 */
UCLASS()
class DEDISERVERTEST_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
    /**
